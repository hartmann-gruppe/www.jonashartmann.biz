/* CONFIGURATION STARTS HERE */
  ...
  const MY_DOMAIN = 'www.jonashartmann.biz';
   ...
   */
  const SLUG_TO_PAGE = {
    '': 'f582e3b1298a4e4597c738255decb09b',
  };
  
  /* Step 3: enter your page title and description for SEO purposes */
  const PAGE_TITLE = 'JONAS HARTMANN';
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-L2BM7HHHQH"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-L2BM7HHHQH');
</script>
